        ...
        <div class="panel-heading">
            <div class="panel-title">
                ...
                <div class="pull-right">
                    <a href="users.php?action=add" class="btn btn-sm btn-success">Add User</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class='btn-group'>
                                        ...
                                        <a href='users.php?action=edit&amp;id=$r->user_id' class='btn btn-primary'>Edit</a>
                                        <a href='users.php?action=delete&amp;id=$r->user_id' class='btn btn-danger'>Delete</a>
                                    </div>
                                </td>
                            </tr>
                        ";
